...
<div class="card has-table">
    ...
    <form method="GET" action="{{ route('brands.index') }}" class="mb-4" style="max-width: 100%;">
        <div class="field" style="display: flex; gap: 10px;">
            ...
            @if(request('search'))
            <div class="control">
                <a href="{{ route('brands.index') }}" class="button is-light" style="height: 40px; min-width: 120px;">
                    ❌ Clear
                </a>
            </div>
            @endif
